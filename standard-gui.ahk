...
if (standardStep = 1) {
	...
	Gui, Add, Picture, h21 vRedX7 w21 x35 y265, %A_ScriptDir%\assets\images\x.jpg
	Gui, Add, Picture, h21 vRedX8 w21 x35 y301, %A_ScriptDir%\assets\images\x.jpg
	Gui, Add, Picture, h21 vRedX9 w21 x35 y337, %A_ScriptDir%\assets\images\x.jpg
	
	; Add the check mark icons beside the last two unordered list items
	Gui, Add, Picture, h21 vCheck6 w21 x35 y463, %A_ScriptDir%\assets\images\check.jpg
	Gui, Add, Picture, h21 vCheck7 w21 x35 y515, %A_ScriptDir%\assets\images\check.jpg
	...
	Gui, Add, Text, backgroundTrans Center Center vTimeOutValue w300 x65 y640, % CountDownSec
